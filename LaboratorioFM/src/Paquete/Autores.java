 ...
 String Base_de_Datos = "jdbc:mysql://127.0.0.1:3306/FilmMagic";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           ...
           Connection cn = DriverManager.getConnection(Base_de_Datos, Usuario, Clave);
            PreparedStatement pst = cn.prepareStatement("update Autor set  Codigo_Autor=?, Nombre_Autor = ?, Apellido_Autor=?, Ciudad_Autor=? where  Codigo_Autor = " + ID);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                  txt_nombre.setText(rs.getString("Codigo_Autor"));
